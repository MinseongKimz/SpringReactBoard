...
const BoardSave = () => {
    ...
    async function AccountLogin(id, pw) {
        ...
        try {
            // axios post 요청 시 url / json data 입력
            const response = await axios.post("http://localhost:8080/api/v1/board", JSON.stringify(boarddto),
                {
                    headers: {
    ...
    return (
        <div className={styles.login_wrap}>
            <div className={styles.login_contents}>
                            ...
                            <td className={styles.login_contents_tbl_td}>
                                <div className={styles.login_contents_tbl_td_div}>
                                    <input type='text' placeholder='제목을 입력하세요'
                                           className={styles.login_contents_tbl_td_div_input} id="account_id"></input>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td className={styles.login_contents_tbl_td}>
                                <div className={styles.login_contents_tbl_td_div}>
                                    <input type='text' placeholder='내용을 입력하세요'
                                           className={styles.login_contents_tbl_td_div_input} id="account_pw"></input>
                                </div>
                            </td>
                        </tr>
                        </tbody>
                ...
                {/*   end region : login_contents_tbl */}

                <div className={styles.login_contents_btn_area}>

                    <input type='button' className={styles.login_contents_btn} value='저장'
